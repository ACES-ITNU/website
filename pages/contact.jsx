        ...
        <section className="text-gray-400 bg-white body-font relative w-10/12 my-14">
          <div className="container px-5  mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
              ...
              <button
                className="text-white bg-orange-600 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded text-lg"
                onClick={SendEmail}
              >
                {LoadText ? LoadText : 'SUBMIT'}
              </button>
